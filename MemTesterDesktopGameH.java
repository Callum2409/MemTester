...
public class MemTesterDesktopGameH extends JFrame implements ActionListener,
		KeyListener {
	...
	public MemTesterDesktopGameH() throws IOException {
		...
		desktop.random(33, 126);// CREATE FIRST RANDOM
